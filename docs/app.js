...
var $author$project$Main$body = function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('What debugging a parser looks like now:')),
				A2(
				...
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('Ah yes, the notoriously missing deadEndsToString.')),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('A straight forward implementation at least gives us this:')),
				A2(
				$author$project$Main$codePreview,
				...
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text('Still this is not very practical when dealing with bigger inputs and bigger parsers.'))
			]));
}();
...
var $author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('ParserUI explained'))
		]));
