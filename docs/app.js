...
var $author$project$Style$pageBackgroundColor = A3($mdgriffith$elm_ui$Element$rgb255, 38, 38, 38);
var $author$project$Style$codeBackgroundColor = $author$project$Style$pageBackgroundColor;
...
var $author$project$Style$darkGrey = A3($mdgriffith$elm_ui$Element$rgb255, 128, 128, 128);
...
var $author$project$Main$indent = $mdgriffith$elm_ui$Element$el(
	_List_fromArray(
		[
...
var $author$project$Main$codeBlock = function (code) {
	return $author$project$Main$indent(
		A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Border$color($author$project$Style$darkGrey),
					$mdgriffith$elm_ui$Element$Border$dashed,
					$mdgriffith$elm_ui$Element$padding(10),
					$mdgriffith$elm_ui$Element$Background$color($author$project$Style$codeBackgroundColor)
				]),
...
var $author$project$Main$showPreview = function (preview) {
	return $author$project$Main$indent(
		A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
...
var $author$project$Main$codePreview = F2(
	function (code, preview) {
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Main$codeBlock(code),
					$author$project$Main$showPreview(preview)
				]));
	});
...
var $author$project$Wip$Main3$input = 'light red bags contain 1 bright white bag, 2 muted yellow bags.\ndark orange bags contain 3 bright white bags, 4 muted yellow bags.\nbright white bags contain 1 shiny gold bag.\nmuted yellow bags contain 2 shiny gold bags, 9 faded blue bags.\nshiny gold bags contain 1 dark olive bag, 2 vibrant plum bags.\ndark olive bags contain 3 faded blue bags, 4 dotted black bags.\nvibrant plum bags contain 5 faded blue bags, 6 dotted black bags.\nfaded blue bags contain no other bags.\ndotted black bags contain no other bags.\n';
...
var $author$project$Wip$Main1$intParser = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
...
var $author$project$Wip$Main1$main = function () {
	var viewParse = function (input) {
		return A2(
			$elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text(
					function () {
						var _v0 = A2($elm$parser$Parser$run, $author$project$Wip$Main1$intParser, input);
						if (_v0.$ === 'Ok') {
							var parsed = _v0.a;
							return $elm$core$String$fromInt(parsed);
						} else {
							var e = _v0.a;
							return $elm$parser$Parser$deadEndsToString(e);
						}
					}())
				]));
	};
...
var $author$project$ParserUI$deadEndToString = function (deadEnd) {
	return _Utils_ap(
		'row: ' + $elm$core$String$fromInt(deadEnd.row),
		_Utils_ap(
			' col: ' + ($elm$core$String$fromInt(deadEnd.col) + ' '),
			function () {
...
var $author$project$ParserUI$deadEndsToString = function (list) {
	return A2(
		$elm$core$String$join,
		'\n',
		A2($elm$core$List$map, $author$project$ParserUI$deadEndToString, list));
};
var $author$project$Wip$Main2$intParser = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$keeper,
...
var $author$project$Wip$Main2$main = function () {
	var viewParse = function (input) {
		return A2(
			$elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text(
					function () {
						var _v0 = A2($elm$parser$Parser$run, $author$project$Wip$Main2$intParser, input);
						if (_v0.$ === 'Ok') {
							var parsed = _v0.a;
							return $elm$core$String$fromInt(parsed);
						} else {
							var e = _v0.a;
							return $author$project$ParserUI$deadEndsToString(e);
						}
					}())
				]));
	};
...
var $author$project$Wip$Main3$bagParser = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed(
	...
	A2(
		...
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					$elm$parser$Parser$token('bag'),
					$elm$parser$Parser$token('bags')
				]))));
var $elm$core$Tuple$pair = F2(
	function (a, b) {
		return _Utils_Tuple2(a, b);
	});
var $author$project$Wip$Main3$nBagsParser = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed($elm$core$Tuple$pair),
		A2($elm$parser$Parser$ignorer, $elm$parser$Parser$int, $elm$parser$Parser$spaces)),
	$author$project$Wip$Main3$bagParser);
...
var $author$project$Wip$Main3$lineParser = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed($elm$core$Tuple$pair),
		A2(
			...
			A2(
				$elm$parser$Parser$ignorer,
				A2($elm$parser$Parser$ignorer, $author$project$Wip$Main3$bagParser, $elm$parser$Parser$spaces),
				$elm$parser$Parser$token('contain')),
			$elm$parser$Parser$spaces)),
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$oneOf(
			_List_fromArray(
				[
					...
					$elm$parser$Parser$token('no other bags')),
					$elm$parser$Parser$sequence(
					{
						end: '',
						item: $author$project$Wip$Main3$nBagsParser,
						separator: ',',
						spaces: $elm$parser$Parser$chompWhile(
							$elm$core$Basics$eq(
								_Utils_chr(' '))),
						start: '',
		...
		$elm$parser$Parser$symbol('.')));
var $author$project$Wip$Main3$parser = $elm$parser$Parser$sequence(
	{end: '', item: $author$project$Wip$Main3$lineParser, separator: '', spaces: $elm$parser$Parser$spaces, start: '', trailing: $elm$parser$Parser$Optional});
var $author$project$Wip$Main3$main = $elm$html$Html$text(
	function () {
		var _v0 = A2($elm$parser$Parser$run, $author$project$Wip$Main3$parser, $author$project$Wip$Main3$input);
		if (_v0.$ === 'Ok') {
			var parsed = _v0.a;
			return 'parsed succesfully';
		} else {
			var e = _v0.a;
			return $author$project$ParserUI$deadEndsToString(e);
		}
...
var $author$project$ParserUI$getAt = F2(
	function (idx, xs) {
...
var $author$project$ParserUI$splitDeadEnd = F2(
	function (input, deadEnd) {
		var line = A2(
			$elm$core$Maybe$withDefault,
			input,
			A2(
				$author$project$ParserUI$getAt,
				deadEnd.row - 1,
				$elm$core$String$lines(input)));
		return {
			after: A2($elm$core$String$dropLeft, deadEnd.col - 1, line),
			before: A2($elm$core$String$left, deadEnd.col - 1, line),
			expected: function () {
				var _v0 = deadEnd.problem;
				switch (_v0.$) {
					case 'Expecting':
			...
			location: 'row ' + ($elm$core$String$fromInt(deadEnd.row) + (' col ' + $elm$core$String$fromInt(deadEnd.col)))
		};
	});
var $author$project$ParserUI$splitDeadEnds = F2(
	function (input, deadEnds) {
		return A2(
			$elm$core$List$map,
			$author$project$ParserUI$splitDeadEnd(input),
			deadEnds);
	});
var $author$project$Wip$Main3$viewSplit = function (split) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('at: ' + split.location)
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Expected: ' + split.before),
						A2(
						$elm$html$Html$u,
						_List_Nil,
						_List_fromArray(
							[
								$elm$html$Html$text(split.expected)
							]))
					])),
				A2(
				$elm$html$Html$p,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('But got:  ' + (split.before + split.after))
					]))
			]));
};
var $author$project$Wip$Main3$main_1b = function () {
	var _v0 = A2($elm$parser$Parser$run, $author$project$Wip$Main3$parser, $author$project$Wip$Main3$input);
	if (_v0.$ === 'Ok') {
		var parsed = _v0.a;
		return $elm$html$Html$text('parsed succesfully');
	} else {
		var e = _v0.a;
		return A2(
			$elm$html$Html$ul,
			...
			A2(
				$elm$core$List$map,
				$author$project$Wip$Main3$viewSplit,
				A2($author$project$ParserUI$splitDeadEnds, $author$project$Wip$Main3$input, e)));
	}
}();
...
var $author$project$Wip$Main3$viewSplit_1c = function (split) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$el,
				_List_Nil,
				$mdgriffith$elm_ui$Element$text(split.location)),
				A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$el,
						_List_Nil,
						$mdgriffith$elm_ui$Element$text(split.before)),
						A2(
						$mdgriffith$elm_ui$Element$el,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Font$color(
								A3($mdgriffith$elm_ui$Element$rgb, 1, 0.25, 0.25))
							]),
						$mdgriffith$elm_ui$Element$text(split.expected))
					])),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
				...
				$mdgriffith$elm_ui$Element$text(
					A2($elm$core$String$left, 100, split.after)))
			]));
};
var $author$project$Wip$Main3$main_1c = function () {
	var _v0 = A2($elm$parser$Parser$run, $author$project$Wip$Main3$parser, $author$project$Wip$Main3$input);
	if (_v0.$ === 'Ok') {
		var parsed = _v0.a;
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_Nil,
			$mdgriffith$elm_ui$Element$text('parsed succesfully'));
	} else {
		var list = _v0.a;
		return A2(
			$mdgriffith$elm_ui$Element$column,
			...
			A2(
				$elm$core$List$map,
				$author$project$Wip$Main3$viewSplit_1c,
				A2(
					$author$project$ParserUI$splitDeadEnds,
					$author$project$Wip$Main3$input,
					A2(
...
var $author$project$Wip$Main3$bagParser_2 = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed(
...
var $author$project$Wip$Main3$nBagsParser_2 = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed($elm$core$Tuple$pair),
		A2($elm$parser$Parser$ignorer, $elm$parser$Parser$int, $elm$parser$Parser$spaces)),
	$author$project$Wip$Main3$bagParser_2);
var $author$project$Wip$Main3$lineParser_2 = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed($elm$core$Tuple$pair),
		A2(
			...
			A2(
				$elm$parser$Parser$ignorer,
				A2($elm$parser$Parser$ignorer, $author$project$Wip$Main3$bagParser_2, $elm$parser$Parser$spaces),
				$elm$parser$Parser$token('contain')),
			$elm$parser$Parser$spaces)),
	A2(
		$elm$parser$Parser$ignorer,
			...
			_List_fromArray(
				[
					...
					$elm$parser$Parser$sequence(
					{
						...
						item: $author$project$Wip$Main3$nBagsParser_2,
						separator: ',',
						spaces: $elm$parser$Parser$chompWhile(
							$elm$core$Basics$eq(
								_Utils_chr(' '))),
		...
		$elm$parser$Parser$symbol('.')));
var $author$project$Wip$Main3$parser_2 = $elm$parser$Parser$sequence(
	{end: '', item: $author$project$Wip$Main3$lineParser_2, separator: '', spaces: $elm$parser$Parser$spaces, start: '', trailing: $elm$parser$Parser$Optional});
var $author$project$Wip$Main3$main_2 = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_Nil,
	$mdgriffith$elm_ui$Element$text(
		function () {
			var _v0 = A2($elm$parser$Parser$run, $author$project$Wip$Main3$parser_2, $author$project$Wip$Main3$input);
			if (_v0.$ === 'Ok') {
				var parsed = _v0.a;
				var viewContents = function (_v2) {
					var i = _v2.a;
					var c = _v2.b;
					return '(' + ($elm$core$String$fromInt(i) + (', \"' + (c + '\")')));
				};
				var viewCollection = A2(
					$elm$core$String$join,
					'\n , ',
					A2(
						$elm$core$List$map,
						function (_v1) {
							...
							return '(\"' + (color + ('\", [' + (A2(
								$elm$core$String$join,
								',',
								A2($elm$core$List$map, viewContents, contents)) + '])')));
						},
						parsed));
...
var $author$project$Main$plainText = function (str) {
	return A2(
		$mdgriffith$elm_ui$Element$paragraph,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$spaceUp = $mdgriffith$elm_ui$Element$el(
	_List_fromArray(
		[
...
var $author$project$Main$body = A2(
	...
	A2(
		...
		_List_fromArray(
			[
				$author$project$Main$plainText('What debugging a parser looks like now.'),
				$author$project$Main$plainText('Say we have this relatively simple parser:'),
				$author$project$Main$codeBlock('\nintParser : Parser Int\nintParser =\n    Parser.oneOf\n        [ Parser.succeed negate\n            |. Parser.symbol "-"\n            |= Parser.int\n        , Parser.int\n        ]\n'),
				$author$project$Main$plainText('and we test it out on a few values like so:'),
				function () {
				var code = '\nmain : Html msg\nmain =\n    let\n        viewParse input =\n            Html.li []\n                [ Html.text <|\n                    case Parser.run intParser input of\n                        Ok parsed ->\n                            String.fromInt parsed\n\n                        Err e ->\n                            Parser.deadEndsToString e\n                ]\n    in\n    Html.ul [] (List.map viewParse [ "5", "-2", "0.0", "blurp" ])\n';
				return A2(
					$author$project$Main$codePreview,
					code,
					$mdgriffith$elm_ui$Element$html($author$project$Wip$Main1$main));
			}(),
				$author$project$Main$plainText('Ah yes, the notoriously missing deadEndsToString.'),
				$author$project$Main$plainText('A basic implementation, that you\'re probably already using, would at least give us this:'),
				A2(
				$author$project$Main$codePreview,
				'ParserUI.deadEndsToString e',
				$mdgriffith$elm_ui$Element$html($author$project$Wip$Main2$main)),
				$author$project$Main$plainText('Still this is not very practical when dealing with bigger inputs and bigger parsers. So let\'s bring them in and see what we can do with them.'),
				$author$project$Main$spaceUp(
				A2(
					$mdgriffith$elm_ui$Element$paragraph,
					_List_Nil,
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$el,
							_List_Nil,
							$mdgriffith$elm_ui$Element$text('This example input text is from ')),
							A2(
							$mdgriffith$elm_ui$Element$newTabLink,
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$Font$underline]),
							{
								label: $mdgriffith$elm_ui$Element$text('advent of code 2020 day 7'),
				...
				$author$project$Main$inputView($author$project$Wip$Main3$input),
				$author$project$Main$plainText('We want to parse this into this model of Elm types:'),
				...
				$author$project$Main$plainText('A succesful parser would give us this:'),
				$author$project$Main$showPreview($author$project$Wip$Main3$main_2),
				$author$project$Main$plainText('Here is a implementation for the parser, with one mistake in it somewhere.'),
				function () {
				...
				return A2(
					$author$project$Main$codePreview,
					code,
					$mdgriffith$elm_ui$Element$html($author$project$Wip$Main3$main));
			}(),
				$author$project$Main$plainText('This error still leaves at lot of work to the reader to figure out where it went wrong and why.'),
				$author$project$Main$spaceUp(
				$author$project$Main$plainText('Let\'s try again with a little more visualization.')),
				$author$project$Main$showPreview(
				$mdgriffith$elm_ui$Element$html($author$project$Wip$Main3$main_1b)),
				$author$project$Main$plainText('This error was rendered by this following snippet. Using ParserUI.splitDeadEnds to process the error data and viewSplit for the HTML.'),
				...
				$author$project$Main$spaceUp(
				$author$project$Main$plainText('Another way to render the same error with elm-ui')),
				$author$project$Main$showPreview($author$project$Wip$Main3$main_1c),
				...
				$author$project$Main$spaceUp(
				$author$project$Main$plainText('By the way the fix for the parser above is as follows')),
				$author$project$Main$codeBlock('\n    -- replace this line\n    |. Parser.oneOf [ Parser.token "bag", Parser.token "bags" ]\n\n    -- by this line\n    |. Parser.oneOf [ Parser.token "bags", Parser.token "bag" ]'),
				$author$project$Main$spaceUp(
				$author$project$Main$plainText('The complete functional code for these examples are availabe in the source files for this demo page.'))
			])));
...
var $author$project$Style$fillWidth = $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill);
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Style$pageTextColor = A3($mdgriffith$elm_ui$Element$rgb255, 220, 211, 177);
...
var $author$project$Main$viewFooter = A2(
	...
	_List_fromArray(
		[
			...
			$author$project$Style$fillWidth,
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('produced to you by Antoine Snyers'))
		]));
var $author$project$Main$viewHeader = A2(
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('ParserUI: helper functions for visualizating errors from elm/parser'))
		]));
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Font$typeface('Menlo')
					])),
				$mdgriffith$elm_ui$Element$Font$color($author$project$Style$pageTextColor),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Style$pageBackgroundColor)
			]),
		_List_fromArray(
			[
